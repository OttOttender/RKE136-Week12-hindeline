...
let api_key = 'b7730786b8e82c47c6e67fa1ce0cb263';
...
app.get('/', (req, res) => {
    let url = `https://api.themoviedb.org/3/movie/550988?api_key=${api_key}`;
    let moviePoster = '';
    axios.get(url)
    .then(response => {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=${api_key}&query=${userMovieTitle}`;
